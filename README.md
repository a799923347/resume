...
# 个人简介
研究生期间研究方向为聚类分析在Hadoop下的实现，毕业后进入挖财从事资产进件、借款人段存管开户、外部资金网关等功能模块的开发与维护，熟悉JDK8、JVM、Redis、Kafka、Dubbo、Hadoop等，熟练使用设计模式

- 优点：学习能力、适应能力优，善沟通、勤思考，做事负责，考虑问题周全
- 缺点：有时不太擅长给自己剪枝

# 分享
团队内部一般每周会进行一次成员之间的分享，包括但不限于自己在某个技术上的学习研究和经验总结、自己业余的兴趣爱好等方面，以下是自己关于单元测试和Java函数式接口的一些学习、思考和总结并进行了内部分享，如果打不开可移步[此处](https://github.com/a799923347/resume)
